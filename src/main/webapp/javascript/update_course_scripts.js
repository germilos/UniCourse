...
function disableAllFormElements() {
    var form = document.getElementById("course_update_form");
    var elements = form.elements;
    for (var i = 0; i < elements.length; i++) {
        if (elements[i].id === 'course_id' || elements[i].id === 'course_cancel' || elements[i].id === 'course_enable') {
            continue;
        }
...
function enableAllFormElements() {
    ...
    for (var i = 0; i < elements.length; i++) {
        if (elements[i].id === 'course_id') {
            continue;
        }
        elements[i].disabled = false;
    }
    document.getElementById('course_enable').disabled = true;
