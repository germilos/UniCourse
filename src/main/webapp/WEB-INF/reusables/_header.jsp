...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="${pageContext.request.contextPath}/index.jsp" style="color:orange">UniCourse</a>
        </div>
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Lecturer <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="action?operation=displayLecturers">View All</a></li>
                    <li><a href="action?operation=addLecturerPage">Insert</a></li>
                </ul>
            </li>
